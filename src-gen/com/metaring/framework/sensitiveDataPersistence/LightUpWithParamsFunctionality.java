...
abstract class LightUpWithParamsFunctionality extends AbstractFunctionality implements GeneratedFunctionality {

    static final FunctionalityInfo INFO = FunctionalityInfo.create("com.metaring.framework.sensitiveDataPersistence.lightUpWithParams", true, false, false, "com.metaring.framework.sensitiveDataPersistence.SensitiveDataInfo", "com.metaring.framework.type.DataRepresentation");

    static final LightUpWithParamsFunctionality INSTANCE = new LightUpWithParamsFunctionalityImpl();

    protected LightUpWithParamsFunctionality() {
