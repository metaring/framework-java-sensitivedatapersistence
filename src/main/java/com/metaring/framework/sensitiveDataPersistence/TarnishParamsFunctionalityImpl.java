...
final class TarnishWithParamsFunctionalityImpl extends TarnishWithParamsFunctionality {

    protected TarnishWithParamsFunctionalityImpl(SysKB sysKB) {
        super(sysKB);
    }
    ...
    protected final CompletableFuture<DataRepresentation> call(SensitiveDataInfo input) throws Exception {
        return end(SensitiveDataRepresentationTransformer.transform(input.getData(), SensitiveDataQueryResolverManager.getParams(input.getParams()), InternalCrypto.INSTANCE::encrypt));
    }
